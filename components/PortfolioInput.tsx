...
const SAMPLE_STOCK_INFO: Record<string, StockInfo> = {
  ...
  AGCO: { ticker: "AGCO", name: "AGCO Corporation", price: 111.35, sector: "Industrials", industry: "Farm & Heavy Construction Machinery" },
  BA: { ticker: "BA", name: "Boeing Company (The)", price: 247.68, sector: "Industrials", industry: "Aerospace & Defense" },
  BG: { ticker: "BG", name: "Bunge Limited", price: 107.81, sector: "Consumer Defensive", industry: "Farm Products" },
  CALM: { ticker: "CALM", name: "Cal-Maine Foods, Inc.", price: 77.92, sector: "Consumer Defensive", industry: "Farm Products" },
  CAT: { ticker: "CAT", name: "Caterpillar, Inc.", price: 646.89, sector: "Industrials", industry: "Farm & Heavy Construction Machinery" },
  CSCO: { ticker: "CSCO", name: "Cisco Systems, Inc.", price: 75.19, sector: "Technology", industry: "Communication Equipment" },
  CVX: { ticker: "CVX", name: "Chevron Corporation", price: 166.26, sector: "Energy", industry: "Oil & Gas Integrated" },
  DDOG: { ticker: "DDOG", name: "Datadog, Inc.", price: 119.02, sector: "Technology", industry: "Software - Application" },
  DE: { ticker: "DE", name: "Deere & Company", price: 514.40, sector: "Industrials", industry: "Farm & Heavy Construction Machinery" },
  GRWG: { ticker: "GRWG", name: "GrowGeneration Corp.", price: 1.49, sector: "Consumer Cyclical", industry: "Specialty Retail" },
  HUM: { ticker: "HUM", name: "Humana Inc.", price: 273.28, sector: "Healthcare", industry: "Healthcare Plans" },
  IBKR: { ticker: "IBKR", name: "Interactive Brokers Group, Inc.", price: 73.36, sector: "Financial Services", industry: "Capital Markets" },
  IEX: { ticker: "IEX", name: "IDEX Corporation", price: 196.93, sector: "Industrials", industry: "Specialty Industrial Machinery" },
  JPM: { ticker: "JPM", name: "JP Morgan Chase & Co.", price: 312.47, sector: "Financial Services", industry: "Banks - Diversified" },
  KO: { ticker: "KO", name: "Coca-Cola Company (The)", price: 70.44, sector: "Consumer Defensive", industry: "Beverages - Non-Alcoholic" },
  LMT: { ticker: "LMT", name: "Lockheed Martin Corporation", price: 582.43, sector: "Industrials", industry: "Aerospace & Defense" },
  MS: { ticker: "MS", name: "Morgan Stanley", price: 189.09, sector: "Financial Services", industry: "Capital Markets" },
  MSCI: { ticker: "MSCI", name: "MSCI Inc.", price: 602.58, sector: "Financial Services", industry: "Financial Data & Stock Exchanges" },
  MSFT: { ticker: "MSFT", name: "Microsoft Corporation", price: 459.86, sector: "Technology", industry: "Software - Infrastructure" },
  NFLX: { ticker: "NFLX", name: "Netflix, Inc.", price: 88.00, sector: "Communication Services", industry: "Entertainment" },
  OSK: { ticker: "OSK", name: "Oshkosh Corporation", price: 152.25, sector: "Industrials", industry: "Farm & Heavy Construction Machinery" },
  PFE: { ticker: "PFE", name: "Pfizer, Inc.", price: 25.65, sector: "Healthcare", industry: "Drug Manufacturers - General" },
  PG: { ticker: "PG", name: "Procter & Gamble Company (The)", price: 144.53, sector: "Consumer Defensive", industry: "Household & Personal Products" },
  SPY: { ticker: "SPY", name: "SPDR S&P 500", price: 691.66, sector: "Financial Services", industry: "Exchange Traded Fund" },
  TMUS: { ticker: "TMUS", name: "T-Mobile US, Inc.", price: 186.32, sector: "Communication Services", industry: "Telecom Services" },
};
